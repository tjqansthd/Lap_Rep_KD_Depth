...
parser.add_argument('--model_encoder_dir',type=str, default = '')
parser.add_argument('--model_decoder_dir',type=str, default = '')
parser.add_argument('--trainfile_kitti', type=str, default = "./datasets/eigen_train_files_with_gt.txt")
parser.add_argument('--testfile_kitti', type=str, default = "./datasets/eigen_test_files_with_gt.txt")
parser.add_argument('--trainfile_nyu', type=str, default = "./datasets/nyudepthv2_train_files_with_gt.txt")
parser.add_argument('--testfile_nyu', type=str, default = "./datasets/nyudepthv2_test_files_with_gt.txt")
...
parser.add_argument('--mode', type=str, default = "RtoD_single")
